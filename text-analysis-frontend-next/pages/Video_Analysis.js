...
export default function Video_Analysis() {
  ...
  const detailsVideo_Analysis = [
    { className: "video_analysis", color: "rgba(216,72,72,0.5)", text: "Video_Analysis 1", indications: "Lorem ipsum dolor sit amet, consectetur adipiscing elit." },
    { className: "video_analysis2", color: "rgba(72,72,216,0.5)", text: "Video_Analysis 2", indications: "Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua." },
    { className: "video_analysis3", color: "rgba(76,216,72,0.5)", text: "Video_Analysis 3", indications: "Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat." },
  ...
  return (
    <>
      <Head>
        <title>{formData?.product && formData?.product} - Video Analysis</title>
      </Head>
        ...
        <div className="row">
          ...
          <div className="col-md-3">
            ...
            <div className="details_score" ref={detailsScoreRef}>
              {detailsVideo_Analysis.map((item, index) => (
                <div key={index}>
